         ...
         <div class="col-md-8">
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  <?php endif; ?>
                  <?php echo form_open("pass/add_host_person");?>

                  <div class="row form-row">
                     <div class="col-md-6">
                        <label class="form-label">Host Person Name</label>
                        <?php echo form_error('host_name'); ?>
                        <input type="text" name="host_name" class="form-control input-sm" placeholder="" value="<?=set_value('host_name')?>">
                     </div>
                     <div class="col-md-6">
                        <label class="form-label">Person Designation</label>
                        <?php echo form_error('host_designation'); ?>
                        <input type="text" name="host_designation" class="form-control input-sm" placeholder="" value="<?=set_value('host_designation')?>">
                     </div>
                  </div>
