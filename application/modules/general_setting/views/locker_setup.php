          ...
          <div class="grid-title">
            ...
            <?php if ($this->ion_auth->in_group(array('badmin'))) {  ?>
              <div class="pull-right">
                <a href="<?=base_url('general_setting/locker_setup_add')?>" class="btn btn-blueviolet btn-xs btn-mini"> Create </a>
              </div>
            <?php } ?>
          </div>
              ...
              <tbody>
                <?php $sl = 0; foreach ($results as $row): $sl++; ?>
                  <tr>
                    ...
                    <td><?php echo anchor(base_url()."general_setting/locker_setup_edit/".$row->id, 'Edit', 'class="btn btn-mini btn-primary"') ;?></td>
                  </tr>
                <?php endforeach;?>
              </tbody>
            </table>
