          ...
          <div class="grid simple horizontal">
             <div class="grid-title">
              ...
              <div class="pull-right">
                <a href="<?=base_url('general_setting/item_unit')?>" class="btn btn-blueviolet btn-xs btn-mini">List</a>
              </div>
             </div>
             <div class="grid-body">
              ...
              <div class="row form-row">
                ...
                <div class="col-md-4">
                  ...
                  <select name="status" id="status" class="form-control input-sm" id="">
                    <option value="">Select</option>
                    <option value="Enable" <?=$info->status=='Enable'?'selected':'';?>>Enable</option>
                    <option value="Disable" <?=$info->status=='Disable'?'selected':'';?>>Disable</option>
                  </select>
                </div>
              </div>
