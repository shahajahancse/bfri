			...
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						...
						<th class="text-center">ইউনিয়ন পরিষদ</th>
				...
				<tbody>
					...
					foreach ($results as $row) { 
						...
						<tr>
							...
							<td class="text-left"><?=$row->org_name //date_bangla_calender_format($row->curr_attend_date)?></td>
							<td class="text-left"><?=$row->uni_name_bn?></td>
							<td class="text-left"><?=$row->upa_name_bn?></td>					
							<td class="text-left"><?=$row->dis_name_bn?></td>
							<td class="text-center"><?=eng2bng($row->how_much_elected)?></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>			
