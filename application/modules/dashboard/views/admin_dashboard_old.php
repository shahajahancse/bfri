         ...
         <div class="col-md-6 col-vlg-3 col-sm-6">
            <div class="tiles blue added-margin  m-b-20">
               <div class="tiles-body">
                  ...
                  <div class="tiles-title text_white_14">Appointment Overview</div>
                  <div class="widget-stats">
                     <div class="wrapper transparent"> 
                        <span class="item-title">Total</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="10000" data-animation-duration="700">0</span>                 
                     </div>
                  </div>
                  <div class="widget-stats">
                     <div class="wrapper transparent">
                        <span class="item-title">Approved</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="2000" data-animation-duration="700">0</span> 
                     </div>
                  </div>
                  <div class="widget-stats ">
                     <div class="wrapper transparent"> 
                        <span class="item-title">Pending</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="500" data-animation-duration="700">0</span>
                     </div>
                  </div>
                  <div class="widget-stats ">
                     <div class="wrapper last"> 
                        <span class="item-title">Reject</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="9857" data-animation-duration="700">0</span> 
                     </div>
                  </div>
               </div>      
            </div>  
         ...
         <div class="col-md-6 col-vlg-3 col-sm-6">
            <div class="tiles green added-margin  m-b-20">
               <div class="tiles-body">
                  ...
                  <div class="widget-stats">
                     <div class="wrapper transparent"> 
                        <span class="item-title">Total Registration</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="5222" data-animation-duration="700">0</span>
                     </div>
                  </div>
                  <div class="widget-stats">
                     <div class="wrapper transparent">
                        <span class="item-title">Today's</span> <span class="item-count animate-number"  style="font-size: 25px;" data-value="100" data-animation-duration="700">0</span> 
                     </div>
                  </div>
                  <div class="widget-stats ">
                     <div class="wrapper last"> 
                        <span class="item-title">Pending</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="1000" data-animation-duration="700">0</span> 
                     </div>
                  </div> 
               </div>      
            </div>  
