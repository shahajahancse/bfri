                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="from_date" id="from_date" class="form-control input-sm" style="padding: 22px!important;"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Select To Date</label>
                                        <input type="date" name="to_date" id="to_date" class="form-control input-sm" style="padding: 22px!important;"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
