            ...
            <div class="grid simple horizontal">
               ...
               <div class="grid-body">
                  ...
                  <?php
                     ...
                     echo form_open_multipart('stock_in/change_status/'.$info->id, $attributes);
                  ?>
                  <!-- purchase title info -->
                  <div class="row">
                     <div class="col-md-12">
                        <fieldset >
                           <legend>Stock Title</legend>
                           <?php
                              ...
                              if ($info->status == 2) {
                                 ...
                                 $status = '<span class="label label-primary"> Division Sm Approve </span>';
                              }else if($info->status == 6){
                                 $status = '<span class="label label-primary"> Division Admin Approve </span>';
                  ...
                  <div class="row form-row">
                     <?php if(in_array($this->unit_id, array(2,3,4)) && $this->ion_auth->in_group(array('do'))) { ?>
                        <div class="col-md-6" style="margin-bottom: 20px;: ">
                           <label class="form-label">Status Type <span class='required'>*</span></label>
                           <input type="radio" name="status" value="5"> <span style="color: black; font-size: 14px;"><strong>Draft</strong></span>
                           <input type="radio" name="status" value="6" checked> <span style="color: black; font-size: 14px;"><strong>Approve</strong></span>
                        </div>
                     <?php } ?>
                     ...
                     <div class="col-md-6" style="margin-bottom: 20px;: ">
                        <label class="form-label">Status Type <span class='required'>*</span></label>
                        <input type="radio" name="status" value="6"> <span style="color: black; font-size: 14px;"><strong>Draft</strong></span>
                        ...
                        <input type="radio" name="status" value="7" checked> <span style="color: black; font-size: 14px;"><strong>Approve</strong></span>
                        <input type="radio" name="status" value="9" <?=$info->status=='7'?'checked':'';?>> <span style="color: black; font-size: 14px;"><strong>Reject</strong></span>
                     ...
                     <div class="col-md-6" style="margin-bottom: 20px;: ">
                        ...
                        <input type="radio" name="status" value="4" <?=$info->status=='4'?'checked':'';?>> <span style="color: black; font-size: 14px;"><strong>Back To SM</strong></span>
                  ...
                  <div class="row form-row">
                     <div class="col-md-12">
                        ...
                        <fieldset>
                           <legend>Stock Entry List</legend>
                           <style type="text/css">
                           ...
                           <table width="100%" border="1" id="appRowDiv">
                              ...
                              <?php foreach($purchase_item_data as $item){
                                 $appt_qty = ($item->approve_qty == 0)?$item->quantity:$item->approve_qty;
                              ?>
                              <tr>
                                 <td><?=$item->item_name?></td>
                                 <td><?=$item->quantity?>  <?=$item->unit_name?></td>
                                 <td><input name="approve_qty[]"  value="<?=$appt_qty?>" class="form-control input-sm"></td>
