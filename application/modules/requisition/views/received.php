            ...
            <div class="grid simple horizontal">
               ...
               <div class="grid-body">
                  ...
                  <?php
                     ...
                     echo form_open_multipart('requisition/delivery_product/'.$info->id, $attributes);
                  ?>
                  <!-- purchase title info -->
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <fieldset>
                           ...
                           <table width="100%" border="1" id="appRowDiv">
                              ...
                              <tr>
                                 ...
                                 <td><input readonly name="qty_approve[]"  value="<?=$item->qty_approve?>" class="form-control input-sm"></td>
