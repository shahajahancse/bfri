        ...
        <div class="row">
            <div class="grid simple ">
                ...
                <div class="grid-body" style="height: 70vh;">
                                ...
                                <td align="right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <?php if($this->ion_auth->in_group(array('do','sm'))&& $row->status==5){ ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4 text-left" style="margin-top: 20px;"> Total
                           <span  style="color: green; font-weight: bold;"><?php echo $total_rows; ?> Requisition </span>
                        </div>
                    </div>
                </div>
            </div>
